                ...
                <div class="tab-content p-3" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <form action="{{ route('users.userStore') }}" method="post" class="container p-2 mx-3"
                                ...
                                <div class="col-sm-6">
                                    <div class="p-3">
                                        ...
                                        <input type="date" id="birthday" name="birthday"
                                            ...
                                            value="{{ $user->userdata->date_of_birth }}" placeholder="">
                                        @error('birthday')
                                            <span class="invalid-feedback" role="alert">{{ __($message) }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="p-3">
                                        ...
                                        <input type="text" name="nationality" value="{{ $user->userdata->nationality }}"
                                ...
                                <div class="col-sm-6">
                                    <div class="p-3">
                                        ...
                                        <select
                                            ...
                                            <option {{ $user->userdata->gender == 'male' ? 'selected' : '' }} value="male">
                                                Male</option>
                                            <option {{ $user->userdata->gender == 'female' ? 'selected' : '' }} value="female">
                                                Female</option>
                                            <option {{ $user->userdata->gender == 'three' ? 'selected' : '' }} value="three">
                                                Three</option>
                                        </select>
                                        @error('gender')
                                            <span class="invalid-feedback" role="alert">{{ __($message) }}</span>
                            ...
                            <div class="row">
                                <x-user.company.photo-section :user="$user" />
                                <x-user.company.banner-section :user="$user" />
                                {{-- <div class="col-sm-6">
                                    <div class="p-3">
                                ...
                                <div class="">
                                    <div class="p-3">
                                        ...
                                        <textarea name="aboutus" class="form-control @error('aboutus') is-invalid @enderror" id="" cols="150"
                                            rows="6">{{ $user->userdata->bio }}</textarea>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        ...
                        <form action="{{ route('users.userStoreother') }}" class="container p-2 mx-3" method="post">
                            <input type="hidden" name="lat" id="lat" value="{{ $user->userdata->lat }}">
                            <input type="hidden" name="lng" id="lng" value="{{ $user->userdata->long }}">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="p-3">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone Number" value="{{ $user->userdata->phone }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="p-3">
                                        <label class="form-label" for="">Email Id</label>
                                        <input type="email" name="email" class="form-control" placeholder="Email Id" value="{{ $login_user->email }}" readonly="">
                                    </div>
                                </div>
                            ...
                            {{-- <div class="mx-3 btn btn" style="background:#0b5ed7"> --}}
                                ...
                                <button type="submit" class="btn btn text-decoration-none text-white" style="background:#0b5ed7">Save</button>
                            {{-- </div> --}}
                                ...
                                <div class="col-sm-6 ">
                                    <div class="p-3">
                                        ...
                                        <input type="text" name="address_line_2" id="address_line_2"
                                            ...
                                            value="{{ $user->userdata->address_line_2 }}">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 ">
                                    <div class="p-3">
                                        ...
                                        <input type="text" class="form-control" name="country" id="country"  placeholder="Country" value="{{ $user->userdata->country }}">
                                    </div>
                                </div>
                                <div class="col-sm-6 ">
                                    <div class="p-3">
                                        <label class="form-label" for="">State</label>
                                        <input type="text" class="form-control" name="state" id="state" placeholder="State" value="{{ $user->userdata->state }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 ">
                                    <div class="p-3">
                                        ...
                                        <input type="text" class="form-control" id="city" name="city" placeholder="City" value="{{ $user->userdata->city }}">
                                    </div>
                                </div>
                                <div class="col-sm-6 ">
                                    <div class="p-3">
                                        <label class="form-label" for="">Pincode</label>
                                        <input type="text" class="form-control" name="pincode" id="pincode" placeholder="Pincode" value="{{ $user->userdata->postcode }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn text-decoration-none text-white" style="background:#0b5ed7">Create Profile</button>
                    </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        function initialize() {
            ...
            google.maps.event.addListener(autocomplete, 'place_changed', function() {
                ...
                // console.log('place.address_components lat ',place.geometry.location.lat());
                // console.log('place.address_components lng ',place.geometry.location.lng());

<div class="rt-site-footer dark-footer">
    <div class="footer-top" style="background-color:#0C1853;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-6 rt-single-widget ">
                    ...
                    <address>
                        <div class="body-font-2 " style="color:#fff">
                            ...
                            @endif
                            <div class="max-312 body-font-4 mt-2 " style="color:#fff">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6 rt-single-widget ">
                    <h2 class="footer-title">{{ __('Quick Links') }}</h2>
                    <ul class="rt-usefulllinks2"> 
                    <li><a style="color:#fff">{{ __('Home') }} </a></li>
                         <li> <a href="{{ route('website.about') }}" style="color:#fff">{{ __('About') }} </a></li>
                        <li> <a style="color:#fff">{{ __('Find Job') }} </a></li>
                              <li> <a style="color:#fff">{{ __('Blog') }} </a></li>
                                 <li> <a  href="{{ route('website.contact') }}" style="color:#fff">{{ __('Contact Us') }} </a></li>
                    </ul>
                </div>
             
                <div class="col-lg-2 col-md-3 col-sm-6 rt-single-widget ">
                    <h2 class="footer-title">{{ __('Hospital') }}</h2>
                    <ul class="rt-usefulllinks2">
                        <li><a style="color:#fff">{{ __('Find Hospital') }}</a></li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6 rt-single-widget ">
                    <h2 class="footer-title">{{ __('Professional') }}</h2>
                    <ul class="rt-usefulllinks2">
                        <li><a style="color:#fff">{{ __('Find Professional') }}</a></li>
                    </ul>
                </div>
                   <div class="col-lg-2 col-md-3 col-sm-6 rt-single-widget ">
                    <h2 class="footer-title">{{ __('Support') }}</h2>
                    <ul class="rt-usefulllinks2">
                        <li><a href="{{ route('website.termsCondition') }}"  style="color:#fff">{{ __('Terms & Conditions') }}</a></li>
                        <li><a href="{{ route('website.privacyPolicy') }}"  style="color:#fff">{{ __('Privacy Policy') }}</a></li>
    ...
    <div class="footer-bottom" style="background-color:#0C1853;" >
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 text-center text-lg-start f-size-14 " style="color:#fff">

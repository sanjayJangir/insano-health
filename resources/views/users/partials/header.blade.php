                                ...
                                <div class="container">
                                    <ul class="menu-active-classes">
                                        ...
                                        <li class="menu-item"><a
                                                ...
                                                href="{{ route('website.candidate') }}">{{ __('Find Healthcare Professionals') }}</a>
                                        </li>
                                        <li class="menu-item"><a
                                    ...
                                    <ul class="menu-active-classes ">
                                        ...
                                        <li class="menu-item">
                                            <a class="{{ linkActive('website.company', 'text-primary active') }}"
                                                href="{{ route('website.company') }}">{{ __('Find Healthcare') }}</a>
                                        </li>
                                        @if(auth('user')->user()->role == 'user')
                                        <li class="menu-item">
                                            <a class="{{ linkActive('website.candidate', 'text-primary active') }}"
                                                href="{{ route('website.candidate') }}">{{ __('Find Healthcare Professionals') }}
                                            </a>
                                        </li>
                                        @endif
                                        <!-- <li class="menu-item">
                                            <a class="{{ linkActive('website.company', 'text-primary active') }}"
                                                href="{{ route('website.company') }}">{{ __('Find Hospitals') }}</a>
                                        </li> -->
                                        <li class="menu-item"><a
                        ...
                        @else
                            <div class="container">
                                <ul class="menu-active-classes ">
                                    ...
                                    <li class="menu-item">
                                        <a class="{{ linkActive('website.candidate', 'text-primary active') }}"
                                            href="{{ route('website.candidate') }}">{{ __('Healthcare Professionals') }}</a>
                                    </li>
                                    <li class="menu-item"><a
                                            class="{{ linkActive('website.company', 'text-primary active') }}"
                                            href="{{ route('website.company') }}">{{ __('Hospitals') }}</a>
                                    </li>
                                    <li class="menu-item"><a
                            ...
                            @auth('user')
                                <ul
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu sadfas" aria-labelledby="dropdownMenuButton1">
                                            <li>

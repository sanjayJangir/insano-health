                            ...
                            <div class="card-row row justify-content-between">
                                <div class="col my-2 d-flex">
                                    <img class="profile-img m-1 my-2 "
                                        src="{{ !empty($savedCandidate->user) ? asset($savedCandidate->user->image) : 'https://jobpilot.templatecookie.com/dummy/images/candidates/candidate-02.jpg' }}"
                                        alt="profile-image" />
                                    <div class="my-1 mx-3">
                                        <h6 class="mb-0 card-name" style="text-align:left">{{ $savedCandidate->user->name }}
                                        </h6>
                                        <p class="mb-0">{{ @$savedCandidate->user->candidate->profession->name }}</p>
                                    </div>
                                </div>
                                <div class="col my-2 d-flex justify-content-end">
                                    <a href="#" class="m-auto text-decoration-none card-link card-text">
                                        <i class=" fal fa-solid fa-bookmark"></i>
                                    </a>

                                    @if (auth('user')->check())
                                        <a onclick="showCandidateProfileModal('{{ $savedCandidate->user->candidate->user->username }}')"
                                    ...
                                    {{-- <button type="button" class="m-auto btn btn-outline-primary buttoncolor">View Profile
                                        <span class="">
                                            <i class="px-1 fal fa-arrow-right"></i>
                                        </span>
                                    </button> --}}
                                    <a href="#" class="m-auto text-decoration-none card-link card-text">

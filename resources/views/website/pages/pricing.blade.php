        ...
        <div class="container">
            <div class="pricing-options tw-justify-between">
                <div class="choose-pricing">
                    <h2>{{ __('Explore All Benefits Of Posting On Insaano Health') }}</h2>
                    <p>{{ __('We have different subscription plans to offer our premium services') }}</p>
                    <a href="#premium_pricing_package">
                        ...
                        {{ __('Choose the one that suits you below') }}
                    </a>
                </div>
                    ...
                    @empty
                        <div class="col-md-12">
                            <div class="card text-center">
                                <x-not-found message="{{ __('NO PRICE, NO PLANS CONTACT INSAANO HEALTH') }}" />
                            </div>
                        </div>
                    @endforelse
                </div>

            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (data.candidate.bookmarked) {
                        ...
                        $('#bookmakCandidateuser').removeClass('d-none')
                    }
                    ...
                    // console.log('data.candidate ',data.candidate.user_id);

                    $('#bookmakCandidateuser').attr('data-user_id',data.candidate.user_id)
                    $('#bookmakCandidateusername').val(data.candidate.user_id);

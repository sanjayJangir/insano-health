                ...
                <div class="col-lg-9">
                    <div class="dashboard-right">
                        <div class="dashboard-right-header rt-mb-32 mt-5">
                            ...
                            <form id="status-filter" class="tw-flex tw-justify-between sm:tw-justify-end tw-gap-3 sm:tw-flex-nowrap tw-w-full tw-flex-wrap tw-items-center" action="{{ route('company.myjob') }}" method="GET">

...
<div >
    ...
    <div class="columns">
        <div class="column is-10 is-offset-1">
            <div class="slideshow2">
                  ...
                  <div class="slide">
                             <section class="banner-section "  style="background-image: url(https://yousongstube.in/frontend/assets/images/banner-main.jpg);background-position: 45% 5%;background-repeat:no-repeat">
            ...
            <div class="container position-parent">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="banner-content5">
                            <div class="mx-727" data-aos="fadeindown" data-aos-duration="1000">
                                <h1 class=" rt-mb-24 " style="  color: #0C1853;">
                                    {{ __('Find a job that fits your interest and skills') }}
                                </h1>
                                <div class="f-size-18 text-gray-800 rt-mb-30">
                                    {{ __('With streamlined searching options to browse') }}
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 d-flex align-items-center">
                        <div class="banner-mockup d-none d-xl-block w-100 text-right">
                            <div class="addimg-1 position-parent video-btn-center">
                                @if ($cms_setting->home_page_banner_image)
                                    ...
                                    <!--    draggable="false">-->
                                @else
                                     <!--<img src="/frontend/assets/images/banner-img.jpg" alt="" class="w-100">-->
                                @endif
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="slide">
                        <section class="banner-section "  style="background-image: url(https://yousongstube.in/frontend/assets/images/banner-main1.jpg); background-position: 50% 20%;background-repeat:no-repeat">
        <div class="rt-single-banner5">
            <div class="container position-parent">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="banner-content5">
                            <div class="mx-727" data-aos="fadeindown" data-aos-duration="1000">
                                <h1 class=" rt-mb-24" style="  color: #0C1853;">
                                    {{ __('Search with the advanced job network') }}
                                </h1>
                                <div class="f-size-18 text-gray-800 rt-mb-30">
                                    {{ __('Be there for the one that needs your skills ') }}
                                </div>
                            </div>
                            <form action="{{ route('website.job') }}" method="GET" id="job_search_form">
                                <div class="jobsearchBox d-flex flex-column flex-md-row bg-gray-10 input-transparent rt-mb-24"
                    ...
                    <div class="slide">
                              <section class="banner-section "  style="background-image: url(https://yousongstube.in/frontend/assets/images/banner-main2.jpg);background-position: 60% 20%;background-repeat:no-repeat">
        <div class="rt-single-banner5">
            <div class="container position-parent">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="banner-content5">
                            <div class="mx-727" data-aos="fadeindown" data-aos-duration="1000">
                                <h1 class=" rt-mb-24" style="  color: #0C1853;">
                                    {{ __('We are committed towards healthcare') }}
                                </h1>
                                <div class="f-size-18 text-gray-800 rt-mb-30">
                                    {{ __('Insaano Health connects people with health') }}
                                </div>
                            </div>
                            <form action="{{ route('website.job') }}" method="GET" id="job_search_form">
                                <div class="jobsearchBox d-flex flex-column flex-md-row bg-gray-10 input-transparent rt-mb-24"
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-sm-6 mx-auto  ">
                    <div class="card jobcardStyle1 counterbox bg-gray-20 hover:bg-gray-10">
                        <div class="card-body" style="height: 121px;">
                            <div class="rt-single-icon-box">
                                ...
                                <div class="iconbox-content">
                                    ...
                                    <span class="text-gray-500 f-size-16">{{ __('live jobs') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body" style="height: 121px;">
                            <div class="rt-single-icon-box">
                                ...
                                <div class="iconbox-content">
                                    ...
                                    <span class="text-gray-500 f-size-16">{{ __('Hospitals') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body" style="height: 121px;">
                            <div class="rt-single-icon-box">
                                ...
                                <div class="iconbox-content">
                                    ...
                                    <span class="text-gray-500 f-size-16">{{ __('Healthcare Professionals') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- We Delivery -->
    <div class="rt-spacer-md-50"></div>
        <div class="">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <span
                            class="body-font-3 ft-wt-5 text-primary-500 rt-mb-15 d-inline-block">{{ __('HEALTH IS WEALTH') }}</span>
                        <h3 class="fw-bold" style="  color: #0C1853;">{{ __('Join Hands With Health With Isaano Heath') }}</h3>
                        <p class="body-font-2 text-gray-500 rt-mb-0">
                            {{ __('We are connecting healthcare professionals to people in need. Connect with us to find more or one for yourself.') }}
                        </p>
                        <div class="offer">
                              <button class="whatWeOffer">What We Offer </button>
                              <div class="callAction">
                              <img src="/frontend/assets/images/call-icon.png" alt="" class="widthimg">
                                <p class="number"> 0 800 555 44 33</p>              
                              </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div>
                            <img src="/frontend/assets/images/about-section.png" alt="" class="w-100">
                        </div>
                    </div>
                </div>
            </div>
      ...
      <!-- We Are Here -->
    <div class="WeAreHere" style="background-image: url(https://yousongstube.in/frontend/assets/images/all-img/whybg.jpg);background-position: right center;" >
            <div class="container weAreHere">
                <div class="row align-items-center  ">
                    <div class="col-md-10">
                        <span
                            class="body-font-3 ft-wt-5 text-primary-500 rt-mb-15 d-inline-block">{{ __('WE ARE HERE') }}</span>
                        <h3 class="rt-mb-32 fw-bold" style="  color: #0C1853;">{{ __('We Will Find You The Best Care For Your Loved Ones, And You') }}</h3>
                        <p class="body-font-2 text-gray-500 rt-mb-0 ">
                            {{ __('A healthcare professional makes the recovery journey neat and smooth with expertise. ') }}
                        </p>
    ...
    <div class="columns">
        <div class="column is-10 is-offset-1">
            <div class="slideshow">
                     <div class="slide">
                       <div class="cardjob">
                       <img src="/frontend/assets/images/verified-account.png" alt="Denim Jeans" class="iconsize">
                       <p class="title">Attendants</p>
                         <p class="textpara"> A sick person can fall sicker if they don’t receive proper care. An attendant keeps up with every healthcare requirement of the patient or needful person by addressing the relatable concerns.</p>
                        
                 </div>          
                 </div>
                     <div class="slide">
                            <div class="cardjob ">
                       <img src="/frontend/assets/images/nurse.png" alt="Denim Jeans" class="iconsize">
                      <p class="title">Nurses</p>
                         <p class="textpara">Patients need professional assistance and support from a healthcare professional who can handle medical situations smoothly. Nurses give patients complete care, from medicine to running small tests. </p>
                          
                 </div>
                 </div>
                     <div class="slide">
                          <div class="cardjob ">
                       <img src="/frontend/assets/images/elderly.png" alt="Denim Jeans"  class="iconsize">
                     <p class="title">Elderly Care</p>
                         <p class="textpara">With age, several factors determine our health, and whether we are healthy or not, elders need attentive care. A professional with experience can understand the needs and give proper supervision.</p>
                          
                 </div>                </div>
                    <div class="slide">
                            <div class="cardjob ">
                       <img src="/frontend/assets/images/baby-boy.png" alt="Denim Jeans" class="iconsize">
                     <p class="title">Baby Care </p>
                         <p class="textpara">Infants are delicate, and they need proper care and handling. They can’t speak about their needs and problems, which makes baby care harder. An experienced person can be a great help with knowledge.</p>
...
<!-- popular vacancy -->
    <div class="most-popular-area rt-pt-100 rt-pt-md-50"  >
        <div class="container">
            <h3 class="fw-bold" style="  color: #0C1853;">{{ __('High In-Demand Jobs') }}</h3>
            <p class="body-font-2 text-gray-500 rt-mb-0 ">
                            {{ __('Find popular healthcare job profiles and apply to them as per your prowess') }}
                        </p>
                ...
                <div class="col-12">
                    <div class="d-flex flex-wrap">
                        <div class="flex-grow-1">
                           <h3 class="fw-bold" style="  color: #0C1853;">{{ __('Popular Categories') }}</h3>
                               <p class="body-font-2 text-gray-500 rt-mb-0 ">
                            {{ __('Find the jobs from the vast healthcare categories suiting to your work profile') }}
                        </p>
                        </div>
   ...
   <!-- Connect Nurse -->
        <div class="bg-gray-20" style="background-image: url(https://yousongstube.in/frontend/assets/images/connect.png)" >
            <div class="container ">
                <div class="row align-items-center  ">
                    <div class="col-md-12 marginsTop">
                        <h3 class="rt-mb-32 fw-bold textstyle" style="  color: #fff; ">{{ __('Connect With Your Healthcare Expert Directly!') }}</h3>
                        <p class="body-font-2 rt-mb-0 textstyle " style=" color: #fff;">
                            {{ __('We have a vast pool of healthcare professionals from different categories. Find the specialist as per your need for satisfactory healthcare services.') }}
                        </p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="flex-grow-1">
                               <h3 class="fw-bold" style="  color: #0C1853;">{{ __('featured_job') }}</h3>
                                   <p class="body-font-2 text-gray-500 rt-mb-0 ">
                            {{ __('Adipiscing elit, sed do eiusmod tempor incididunt ut dolore magna aliqua.') }}
                        </p>
                            </div>
    ...
    @if ($top_companies->count() > 0)
        <section class="featurejob-area rt-pt-100 rt-pt-md-50 bg-gray-20 ">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="flex-grow-1">
                               <h3 class="fw-bold" style="  color: #0C1853;">{{ __('top') }} <span
                                        class="text-primary-500 has-title-shape">{{ __('Hospitals') }}
                                        <img src="{{ asset('frontend') }}/assets/images/all-img/title-shape.png"
                                            alt="">
                                    </span></h3>
                                       <p class="body-font-2 text-gray-500 rt-mb-0 ">
                            {{ __('Find job positions in the topmost hospitals under your job profile') }}
                        </p>
                            </div>
    ...
    @if ($testimonials->count())
     <div class=" rt-spacer-md-0"></div>
        <section class="testimoinals-area bg-gray-20" style="background-image: url(https://yousongstube.in/frontend/assets/images/all-img/whybg.jpg);background-position: right center;" >
            <div class=" rt-spacer-md-50 rt-spacer-100"></div>
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                         <span
                            class="body-font-3 ft-wt-5 text-primary-500 rt-mb-15 d-inline-block">{{ __('CLIENT SAYS ABOUT US') }}</span>
                       <h3 class="fw-bold" style="  color: #0C1853;">{{ __('Best Caregiving Services in the World') }}</h3>
                           <p class="body-font-2 text-gray-500 rt-mb-0 ">
                            {{ __('Adipiscing elit, sed do eiusmod tempor incididunt ut dolore magna aliqua.') }}
                        </p>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center text-h4 ft-wt-5">
                 <h3 class="fw-bold" style="  color: #0C1853;"> <label for="">{{ __('Apply With') }}</label>  <span class="text-primary-500 has-title-shape">{{ config('app.name') }}
                        <img src="{{ asset('frontend') }}/assets/images/all-img/title-shape.png" alt="">
                    </span>
                     </h3> 
                       <p class="body-font-2 text-gray-500 rt-mb-0 ">
                            {{ __('We have built an easy-to-use platform in simple steps') }}
                        </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 rt-mb-24 position-parent">
                    ...
                    <div class="rt-single-icon-box working-progress icon-center">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">{{ __('Create Account') }}</div>
                            <div class="body-font-4 text-gray-400">
                                {{ __('Begin your search by signing up on our website as a CANDIDATE.') }}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 rt-mb-24 col-sm-6 position-parent">
                    ...
                    <div class="rt-single-icon-box working-progress icon-center">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">{{ __('Upload CV/Resume') }}</div>
                            <div class="body-font-4 text-gray-400">
                                {{ __('Build a strong resume and upload it on our platform for employers. ') }}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 rt-mb-24 col-sm-6 position-parent">
                    ...
                    <div class="rt-single-icon-box working-progress icon-center">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">{{ __('Find Suitable Job') }}</div>
                            <div class="body-font-4 text-gray-400">
                                {{ __('Browse the vast spectrum of job opportunities as per your mastery.') }}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 rt-mb-24 col-sm-6">
                    <div class="rt-single-icon-box working-progress icon-center">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">{{ __('Apply For Job') }}</div>
                            <div class="body-font-4 text-gray-400">
                                {{ __('Bounce back to Insaano Health after applying and keep searching.') }}</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--Hire Nurse -->
       ...
       <div class="" style="text:#DEFDFF">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                       <h3 class="fw-bold" style="  color: #0C1853;">{{ __('Hire The Healthcare Professionals') }}</h3>
                        <p class="body-font-2 text-gray-500 rt-mb-0">
                            {{ __('Insaano Health offers a large range of healthcare specialists from different categories and various job profiles for individuals and hospitals. Find the one fitting your requirement simply with us. ') }}
                        </p>
                        <div class="offer">
                              <button class="whatWeOffer">Start Recruiting Now </button>
                        </div>
                      
                    </div>
                    <div class="col-md-6">
                        <div>
                            <img src="/frontend/assets/images/nurseimg.png" alt="" class="w-100">
                        </div>
                    </div>
                </div>
            </div>

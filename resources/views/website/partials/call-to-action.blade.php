        ...
        <div class="row">
            <div class="col-xl-6 rt-mb-24">
                <div class="cta-1 ct-height bgprefix-cover"
                    ...
                    <h5 class="rt-mb-15">Find The Best Jobs!</h5>
                    <div class="body-font-4 rt-mb-24 text-gray-600 max-312">
                        {{ __('Join us as a candidate to explore the vast healthcare job opportunities under trusted employers.') }}
                    </div>
            ...
            <div class="col-xl-6 rt-mb-24">
                <div class="cta-1 ct-height bgprefix-cover"
                    ...
                    <!--<h5 class="rt-mb-15 ">{{ __('employers_title') }}</h5>-->
                    <h5 class="rt-mb-15">Hire The Specialists!</h5>
                    <div class="body-font-4 rt-mb-24 text-gray-600 max-312">
                        {{ __('Join us as an employer to find the expert healthcare professionals from different categories and for different jobs.') }}
                    </div>
                    <form action="{{ route('register') }}" method="GET">

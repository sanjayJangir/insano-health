                            ...
                            <div class="rt-mb-md-10">
                                ...
                                @if (Auth::user()->role == 'user')
                                    <a id="bookmakCandidateuser"
                                        ...
                                        onclick="bookmakCandidateuser(this)">
                                        <input type="hidden" name="bookmakCandidateusername"
                                            id="bookmakCandidateusername" class="bookmakCandidateusername">
                                ...
                                {{-- Already bookmarked  --}}
                                @if (Auth::user()->role == 'user')
                                    <a id="removebookmakCandidateuser"
                                        class="d-none bg-primary-50 text-primary-500 plain-button icon-48 btn-star-white hover:bg-primary-500 hover:text-primary-50">
...
<script>
    function bookmakCandidateuser() {
        let CID = $('#bookmakCandidateusername').val();
        $.ajax({
            url: "{{ route('users.save_bookmark') }}",
            type: "post",
            data: {
                _token: '{{ csrf_token() }}',
                CID: CID,
            ...
            success: function(data) {
                ...
                if (data.done == 1) {
                    $('#bookmakCandidateuser').addClass('d-none')
                    $('#removebookmakCandidateuser').removeClass('d-none')
                }
            }
        });

...
<div class="col-lg-4">
    ...
    <div id="photo-uploadMode" class="{{ $user->userdata->logo ? 'd-none' : '' }}">
    ...
    <div id="photo-oldMode" class="{{ $user->userdata->logo ? '' : 'd-none' }}">
        <div class="profile-file-upload-content2">
            <img class="profile-file-upload-image" src="{{ $user->userdata->logo_url }}"
                alt="your image" />

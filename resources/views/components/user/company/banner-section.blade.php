...
<div class="col-lg-8">
    ...
    <div id="banner-uploadMode" class="{{  $user->userdata->banner ? 'd-none' : '' }}">
    ...
    <div  id="banner-oldMode" class="{{  $user->userdata->banner ? '' : 'd-none' }} banner-file-upload-content2">
        <img class="banner-file-upload-image" src="{{  $user->userdata->banner_url }}"
            alt="your image" />

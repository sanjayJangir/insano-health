        ...
        <div class="content">
            ...
            <div class="dashboard-content px-3 pt-4">
                ...
                <div class="row gapinrow">
                        <div class="col d-flex tw-justify-between"><p style="text-align:left; font-size:17px;font-weight:500;">Recent Candidate <span class="text-secondary" style="text-align:left; font-size:17px;font-weight:500;">(3)</span>
                    ...
                    <div class="card-row row justify-content-between">
                        ...
                        <div class="col my-2 d-flex justify-content-end">
                            <!-- <a href="#" class="m-auto text-decoration-none card-link card-text"><i
                                    ...
                                    <button type="button" class="m-auto btn btn-outline-primary buttoncolor">View Profile<span class=""><i
                                        class="px-1 fal fa-arrow-right"></span></i></button>
                            <a href="#" class="m-auto text-decoration-none card-link card-text"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="16" height="19" fill="currentColor" class="bi bi-three-dots-vertical" viewBox="0 0 16 16">
                                    <path

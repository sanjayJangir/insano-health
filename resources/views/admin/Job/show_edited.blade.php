                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <div class="p-half rounded">
                                        <x-website.map.map-warning />
                                        @if ($map == 'map-box')
                                            <div class="map mymap" id='map-box2'></div>
                                        @elseif ($map == 'google-map')
...
@section('script')
    ...
    @if ($map == 'map-box')
        ...
        <x-map.mapbox id="map-box" :lat="$job->lat" :long="$job->long" container="map2" coordinates="coordinates" />
        <x-map.mapbox id="map-box2" :lat="$parent_job->lat" :long="$parent_job->long" container="map3" coordinates="coordinates3" />

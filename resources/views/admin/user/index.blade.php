            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title line-height-36">{{ __('user_list') }}</h3>
                        {{-- <div>
                            ...
                            @if ($candidates->count() > 0)
                                @foreach ($candidates as $candidate)
                                    <tr>
                                        ...
                                        <td class="text-center" tabindex="0">
                                            <a href="{{ route('users.show', $candidate->id) }}" class="">
                                                {{ $candidate->user->name }}
                                            </a>
                                        </td>
                                        <td class="text-center" tabindex="0">
                                        ...
                                        @if (userCan('candidate.update') || userCan('candidate.delete'))
                                            <td class="text-center">
                                                @if (userCan('candidate.view'))
                                                    <a href="{{ route('users.show', $candidate->id) }}"
                                                ...
                                                @if (userCan('candidate.delete'))
                                                    <form action="{{ route('users.destroy', $candidate->id) }}"
